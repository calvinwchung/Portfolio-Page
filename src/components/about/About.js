    ...
    <div className="about">
      ...
      <div className='about-right'>
        ...
        <h4 className='about-sub'>
          nucamp full stack developer graduate<br/>
          temple university graduate: finance<br/>
          senior finance associate at jpmorgan chase
        </h4>
        <p className='about-desc'>
          i graduated from temple university fox school of business with a finance degree. i worked at jpmorgan chase in the finance department for about 7-8 years before joining nucamp to pursue coding. i've learned many languages including: react, react native, javascript, html, css, bootstrap, mongo db, express js node, etc. i've worked on various projects to demonstrate my proficiency in the listed languages. Please continue to scroll down to see a small list of projects I've completed or visit my github.
        </p>
        <div className='about-nucamp'>
          ...
          <div className='about-nucamp-texts'>
            ...
            <p className='about-nucamp-sub'>
              full stack developer student with a concentration on react, react native, nodejs, express and mongodb.
            </p>
          </div>
        </div>
      </div>
